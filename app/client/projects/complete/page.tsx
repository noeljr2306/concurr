  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-slate-100 p-8">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 w-full max-w-[600px] px-12 py-12 text-center">
        ...
        {/* Text */}
        <h1 className="text-[30px] font-bold text-slate-900 mb-3">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-3 w-full py-4 bg-indigo-700 hover:bg-indigo-800 text-white text-[15px] font-bold rounded-xl transition-colors mb-8"
        >
          Close Project
