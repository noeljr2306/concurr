...
const TIMEZONES = [
  "UTC-8 Pacific Time","UTC-7 Mountain Time","UTC-6 Central Time",
  "UTC-5 Eastern Time","UTC+0 GMT","UTC+1 CET","UTC+5:30 IST","UTC+8 SGT","UTC+9 JST",
];
      ...
      <header className="px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-indigo-700 flex items-center justify-center">
            <ShieldCheck size={15} strokeWidth={2} className="text-white" />
          </div>
          <span className="font-bold text-[16px] text-slate-900 tracking-tight">Concurr</span>
        </div>
        {/* Avatar placeholder */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 w-full max-w-[420px] p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl text-[14px] text-slate-500 bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-all"
                >
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-indigo-700 hover:bg-indigo-800 text-white text-[14.5px] font-bold rounded-xl transition-colors mt-2"
            >
          ...
          <p className="text-center text-[13px] text-slate-400 mt-5">
            ...
            <Link href="/auth/login" className="text-indigo-700 font-semibold hover:underline">Log in</Link>
          </p>
        </div>
